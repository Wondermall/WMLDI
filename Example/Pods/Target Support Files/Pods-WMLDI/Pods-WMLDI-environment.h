...
// WMLDI
#define COCOAPODS_POD_AVAILABLE_WMLDI
#define COCOAPODS_VERSION_MAJOR_WMLDI 0
#define COCOAPODS_VERSION_MINOR_WMLDI 1
#define COCOAPODS_VERSION_PATCH_WMLDI 0
